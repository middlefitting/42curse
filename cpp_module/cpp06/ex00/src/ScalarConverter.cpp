...
void ScalarConverter::initConverterInfo(t_converter_info *info_dts,
...
void ScalarConverter::initType(t_converter_info *info_dts) {
  ...
  if (info_dts->type == NONE) throw std::runtime_error("Unknown type");
}
...
void ScalarConverter::convertFromChar(t_converter_info *info_dts) {
  info_dts->cast_value.cast_int =
      static_cast<int>(info_dts->cast_value.cast_char);
  info_dts->cast_value.cast_float =
      static_cast<float>(info_dts->cast_value.cast_char);
  info_dts->cast_value.cast_double =
      static_cast<double>(info_dts->cast_value.cast_char);
}
...
void ScalarConverter::intConverter(t_converter_info *info_dts) {
  ...
  if (!errnoOverflowChecker()) info_dts->status[INT] = OVERFLOWED;

  if (!intRangeChecker(result)) info_dts->status[INT] = OVERFLOWED;
...
void ScalarConverter::convertFromInt(t_converter_info *info_dts) {
  info_dts->cast_value.cast_char =
      static_cast<char>(info_dts->cast_value.cast_int);
  info_dts->cast_value.cast_float =
      static_cast<float>(info_dts->cast_value.cast_int);
  info_dts->cast_value.cast_double =
      static_cast<double>(info_dts->cast_value.cast_int);
...
void ScalarConverter::floatConverter(t_converter_info *info_dts) {
  ...
  if (!errnoOverflowChecker()) info_dts->status[FLOAT] = OVERFLOWED;

  if (!floatRangeChecker(result)) info_dts->status[FLOAT] = OVERFLOWED;
...
void ScalarConverter::convertFromFloat(t_converter_info *info_dts) {
  info_dts->cast_value.cast_int =
      static_cast<int>(info_dts->cast_value.cast_float);
  info_dts->cast_value.cast_char =
      static_cast<char>(info_dts->cast_value.cast_float);
  info_dts->cast_value.cast_double =
      static_cast<double>(info_dts->cast_value.cast_float);
...
void ScalarConverter::doubleConverter(t_converter_info *info_dts) {
  ...
  if (!errnoOverflowChecker()) info_dts->status[DOUBLE] = OVERFLOWED;
...
void ScalarConverter::convertFromDouble(t_converter_info *info_dts) {
  info_dts->cast_value.cast_int =
      static_cast<int>(info_dts->cast_value.cast_double);
  info_dts->cast_value.cast_char =
      static_cast<char>(info_dts->cast_value.cast_double);
  info_dts->cast_value.cast_float =
      static_cast<double>(info_dts->cast_value.cast_double);
...
bool ScalarConverter::intRangeChecker(long value) {
  if (static_cast<long>(static_cast<int>(value)) != value) return false;
  return true;
}
